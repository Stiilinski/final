...
<div id="container">
    ...
    ?>
                <form action="includes/update.php" method="post">
                    <input type="hidden" name="id" value="<?php echo $userData['p_id']; ?>">
                    <label for="name">Name:</label>
                    <input type="text" name="name" id="name" value="<?php echo $userData['p_name']; ?>">

                    <label for="email">Email:</label>
                    <input type="text" name="email" id="email" value="<?php echo $userData['p_email']; ?>">
